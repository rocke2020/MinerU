...
if __name__ == '__main__':
    # args
    os.environ['MINERU_MODEL_SOURCE'] = "local"  # Use modelscope to download models
    ...
    parse_doc(doc_path_list, output_dir, backend="vlm-sglang-client", server_url='http://123.125.232.26:16543')
